    ...
    <>
      {subjects.map((subject) => (
        <button
          ...
          className="flex items-center gap-x-4 bg-valkoinen dark:bg-perameri py-3 px-4 xl:py-5 rounded-2xl shadow-lg ring-1 hover:ring-perameri transition-all"
        >
          <div
          ...
          <p className="text-yotaivas dark:text-valkoinen text-xl font-semibold">{subject.title}</p>
        </button>
      ))}
    </>
  );
